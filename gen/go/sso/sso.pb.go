...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x9e, 0x02, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x39, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69,
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	0, // 4: auth.Auth.CreateApp:input_type -> auth.CreateAppRequest
	5, // 5: auth.Auth.Register:output_type -> auth.RegisterResponse
	7, // 6: auth.Auth.Login:output_type -> auth.LoginResponse
	3, // 7: auth.Auth.IsAdmin:output_type -> auth.IsAdminResponse
	9, // 8: auth.Auth.Logout:output_type -> auth.LogoutResponse
	1, // 9: auth.Auth.CreateApp:output_type -> auth.CreateAppResponse
